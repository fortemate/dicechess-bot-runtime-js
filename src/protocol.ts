/**
 * Public wire and strategy contracts.
...
/** Gameplay events supported by the runtime and pinned server. */
...
/** Cooperative cancellation; late results are discarded by the handler. */
